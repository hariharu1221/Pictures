...
void Stage_2_0::Init()
{
	mciSendString(L"play ./Resource/sound/stage_2.mp3 repeat", NULL, 0, NULL);
	srand(time(NULL));
	bullet = new cBulletAdmin();
	player = new cPlayer(bullet->m_bullets);
	boss = new boss_2(bullet->m_bullets);
...
void Stage_2_0::Release()
{
	...
	mciSendString(L"stop ./Resource/sound/stage_2.mp3", NULL, 0, NULL);
}
